// --------------------------------------------------------------------------------------------------
// <copyright file="TokenService.cs" company="">
...
namespace Modules.Identity.Infrastructure.Services
{
    public class TokenService : ITokenService
    {
        ...
        private async Task<string> GenerateJwtAsync(BoilerplateUser user, string ipAddress)
        {
            return GenerateEncryptedToken(GetSigningCredentials(), await GetClaimsAsync(user, ipAddress));
        }

        private async Task<IEnumerable<Claim>> GetClaimsAsync(BoilerplateUser user, string ipAddress)
        {
